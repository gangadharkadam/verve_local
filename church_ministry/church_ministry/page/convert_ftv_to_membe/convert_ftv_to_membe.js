frappe.pages['convert-ftv-to-membe'].on_page_load = function(wrapper) {
	frappe.ui.make_app_page({
		parent: wrapper,
		title: 'Convert FTV to Member',
		single_column: true
	});
...
frappe.assign = Class.extend({
	...
	setup_page: function(){
		...
		frappe.call({
				method:"church_ministry.church_ministry.page.convert_ftv_to_membe.convert_ftv_to_membe.loadftv",
				args:{
	        	},
				callback: function(r) {
					if (r.message.ftv){
...
var assign = function(ftv){
	frappe.call({
	        method:"church_ministry.church_ministry.page.convert_ftv_to_membe.convert_ftv_to_membe.approveftv",
	        args:{
	        	"ftv":ftv      
	        },        
	        callback: function(r) {
