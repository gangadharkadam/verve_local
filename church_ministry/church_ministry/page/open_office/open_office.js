...
frappe.assign = Class.extend({
	...
	setup_sms: function(){
        ...
        $('.sendsms').find('.btn-send').click(function() {         
				...
				frappe.call({
			        method:"church_ministry.church_ministry.page.open_office.open_office.process",
			        args:{
			        	"data":name		        	
			        	},
			        callback: function(r) {
						...
						function success(e){*/
													/*frappe.call({
														...
														callback: function(r) {
															...
															//window.open(r.message['user1']);
															//window.open(r.message['user2']);
													 	}
											    });*/
					//	}	
		})		
...
var add_cnt = function(){
	...
	$('.members').remove();
	frappe.call({
				method:"church_ministry.church_ministry.page.open_office.open_office.get_users",
				callback: function(r) {									
								h1=''		            
