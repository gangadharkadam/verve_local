...
frappe.ui.form.on("Foundation School Class Attendance", "onload", function(frm,cdt,cdn,doc) {
...
frappe.ui.form.on("Foundation School Class Attendance", "refresh", function(frm,cdt,cdn,doc) {
    cur_frm.fields_dict["attendance"].grid.set_column_disp("attendance",true );
    cur_frm.cscript.toggle_related_fields(frm.doc);
});

frappe.ui.form.on("Foundation School Class Attendance", "church", function(frm,cdt,cdn,doc) {
...
frappe.ui.form.on("Foundation School Class Attendance", "visitor_type", function(frm,doc) {
